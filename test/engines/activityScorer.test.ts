...
function createMockDayData(): DayDetailsData {
  return {
    ...
    allHours: [
      { name: 'Tý', timeRange: '23:00 - 01:00', canChi: { can: 'Giáp', chi: 'Tý' }, isAuspicious: true, score: 70, nghi: [], ky: [] },
      { name: 'Sửu', timeRange: '01:00 - 03:00', canChi: { can: 'Ất', chi: 'Sửu' }, isAuspicious: true, score: 65, nghi: [], ky: [] },
      { name: 'Dần', timeRange: '03:00 - 05:00', canChi: { can: 'Bính', chi: 'Dần' }, isAuspicious: false, score: 40, nghi: [], ky: [] },
    ],
    auspiciousHours: [],
    inauspiciousHours: [],
    ...
    advancedIndicators: [],
    foundationalLayer: { baseScore: 10, thanSat: [], auspiciousDirections: { hyThan: 'Đông Bắc', taiThan: 'Đông Nam', hacThan: 'Tây Bắc' } },
    modifyingLayer: {
      stars: [],
