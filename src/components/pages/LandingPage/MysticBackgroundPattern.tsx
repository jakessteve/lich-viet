...
export default function MysticBackgroundPattern({ variant, className = '' }: MysticBackgroundPatternProps) {
    ...
    return (
      <svg className="w-full h-full" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g style={{ animation: 'spin 160s linear infinite', transformOrigin: 'center' }}>
          ...
          <g opacity="0.5">
            {[...Array(24)].map((_, i) => (
              <line key={`rad-24-${i}`} x1="400" y1="40" x2="400" y2="340" stroke="url(#mysticGold)" strokeWidth="0.75" transform={`rotate(${i * 15} 400 400)`} />
            ))}
          </g>
          {/* 64 Hexagrams outer tick marks */}
          <g opacity="0.3">
            {[...Array(64)].map((_, i) => (
              <line key={`rad-64-${i}`} x1="400" y1="80" x2="400" y2="130" stroke="url(#mysticGold)" strokeWidth="0.5" transform={`rotate(${i * (360/64)} 400 400)`} />
            ))}
          </g>
          {/* Inner core */}
  ...
  const renderLuoshu = () => {
    ...
    const offset = 160;
    const nodes = [
      [400 - offset, 400 - offset], [400, 400 - offset], [400 + offset, 400 - offset],
      [400 - offset, 400],          [400, 400],          [400 + offset, 400],
      [400 - offset, 400 + offset], [400, 400 + offset], [400 + offset, 400 + offset]
    ];
    return (
      <svg className="w-full h-full" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g style={{ animation: 'spin 200s linear infinite reverse', transformOrigin: 'center' }}>
          ...
          <circle cx="400" cy="400" r="340" stroke="url(#mysticGold)" strokeWidth="0.5" strokeDasharray="5 15" opacity="0.3" />
  ...
  const renderDipper = () => {
    ...
    return (
      <svg className="w-full h-full" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="400" cy="400" r="360" stroke="url(#mysticGold)" strokeWidth="1" strokeDasharray="3 9" opacity="0.3" />
        ...
        <g style={{ animation: 'spin 180s linear infinite', transformOrigin: 'center' }}>
          ...
          <path d="M 240 280 L 320 220 L 380 260 L 410 340 L 490 420 L 570 460 L 650 430" 
                stroke="url(#mysticGold)" strokeWidth="3" fill="none" opacity="0.6" strokeLinejoin="round" />
          <path d="M 410 340 L 240 280" 
                stroke="url(#mysticGold)" strokeWidth="3" fill="none" opacity="0.4" strokeLinejoin="round" />

          {/* Specific offset stars */}
          {[
            [240, 280], [320, 220], [380, 260], [410, 340],
            [490, 420], [570, 460], [650, 430]
          ].map(([x, y], i) => (
            <g key={i}>
          ...
          {[...Array(30)].map((_, i) => (
            <circle 
              ...
              r={1.5} fill="#d4a843" opacity={0.1 + (i % 5) * 0.1} 
            />
          ))}
        </g>
      </svg>
    ...
    return (
      <svg className="w-full h-full" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g style={{ animation: 'spin 140s linear infinite reverse', transformOrigin: 'center' }}>
          ...
          <circle cx="400" cy="400" r="350" stroke="url(#mysticGold)" strokeWidth="1" strokeDasharray="10 10" opacity="0.3" />
          ...
          {[0, 90, 180, 270].map((angle) => (
            <g key={angle} transform={`rotate(${angle} 400 400)`}>
              ...
              <path d="M 350 140 Q 400 170 450 140" fill="none" stroke="url(#mysticGold)" strokeWidth="1.5" opacity="0.4" />
              ...
              <line x1="400" y1="140" x2="400" y2="260" stroke="url(#mysticGold)" strokeWidth="1" opacity="0.3" strokeDasharray="3 6" />
            </g>
          ))}
          ...
          <g opacity="0.2">
            {[45, 135, 225, 315].map(angle => (
              <line 
                ...
                stroke="url(#mysticGold)" strokeWidth="0.5" 
