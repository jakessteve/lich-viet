...
export const NAP_AM_HANH: Record<string, string> = {
    ...
    'Phích Lịch Hỏa': 'Hỏa', 'Tùng Bách Mộc': 'Mộc', 'Trường Lưu Thủy': 'Thủy',
    'Sa Trung Kim': 'Kim', 'Sơn Hạ Hỏa': 'Hỏa', 'Bình Địa Mộc': 'Mộc',
    'Bích Thượng Thổ': 'Thổ', 'Kim Bạc Kim': 'Kim', 'Phúc Đăng Hỏa': 'Hỏa',
    'Thiên Hà Thủy': 'Thủy', 'Đại Dịch Thổ': 'Thổ', 'Thoa Xuyến Kim': 'Kim',
    'Tang Chá Mộc': 'Mộc', 'Đại Khê Thủy': 'Thủy', 'Sa Trung Thổ': 'Thổ',
